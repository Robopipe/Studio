...
export type ModelUpdate = Partial<Pick<ModelInsert, "name" | "epochs" | "splitTest" | "splitValidate" | "splitTrain" | "status" | "outputTypes" | "backend" | "region" | "quantization" | "trainingType" | "annotationsUsed" | "customHyperparams" | "errorMessage" | "finalAccuracy" | "finalLoss" | "datasetVersionId" | "batchJobName">>
