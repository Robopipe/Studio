...
export type ModelUpdate = Partial<Pick<ModelInsert, "name" | "epochs" | "splitTest" | "splitValidate" | "splitTrain" | "status" | "outputTypes" | "trainingType" | "annotationsUsed" | "customHyperparams">>
