...
export const ClassSelect = ({
  ...
  const isEmpty = labels.length === 0 && !isLoadingLabels;

  return (
    <div className="relative flex max-w-full items-center gap-2 rounded-2xl border border-black/10 bg-white/95 p-2 shadow-[0_0_12px_rgba(0,0,0,0.08)] backdrop-blur-md">
      <CreateLabelPopover existingLabels={labels} onCreate={onCreateLabel} />
