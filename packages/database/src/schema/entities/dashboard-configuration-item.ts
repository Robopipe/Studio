...
export const dashboardConfigurationItemTypeEnum = p.pgEnum(
  "dashboard_configuration_item_type_enum",
  [
...
export const dashboardConfigurationItemSeverityEnum = p.pgEnum(
  "dashboard_configuration_item_severity_enum",
  [
...
export const dashboardConfigurationItemPositionEnum = p.pgEnum(
  "dashboard_configuration_item_position_enum",
  [
...
export const dashboardConfigurationItemLimitUnitEnum = p.pgEnum(
  "dashboard_configuration_item_limit_unit_enum",
  [
...
export const dashboardConfigurationItemTable = p.pgTable(
  "dashboard_configuration_item",
  {
    id,
    dashboardConfigurationId: p
      .integer("dashboard_configuration_id")
    ...
    targetLabelId: p
      ...
      .notNull(),
    targetParentLabelId: p
      .integer("target_parent_label")
      .references(() => projectLabelTable.id, { onDelete: "cascade" }),
    limits: p
      .jsonb("limits")
      .notNull()
