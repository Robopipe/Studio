...
_urlpatterns = [
    ...
    path(
        "<int:pk>/capture/",
        views.project_capture,
        name="project-capture",
        kwargs={"mode": ""},
    ),
    path("<int:pk>/capture/<mode>", views.project_capture, name="project-capture-mode"),
    path("<int:pk>/train/", views.project_train, name="project-train"),
    path("<int:pk>/infere", views.project_infere, name="project-infere"),
    path(
        "upload-example/",
        views.upload_example_using_config,
